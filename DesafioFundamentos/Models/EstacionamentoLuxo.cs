...
namespace RepositorioEstacionamentoOF.Models
{
    public class EstacionamentoLuxo : Estacionamento
    {
        ...
        public List<EstacionamentoLuxo> ListLuxo { get; set; } = new List<EstacionamentoLuxo>();   /// tentar criar esse obj e add na lista para dar certo 
        ...
        public sealed override void RemoveVehicle(DateTime moment) // DAteTime.Now
        {
            ...
            {
                Console.WriteLine($"Veiculo com placa: {plate} não está estacionado. Verifique se digitou corretamente!");
                Console.WriteLine("Aperte qualquer botão");
                Console.ReadLine();
                Console.Clear();
            }   
        ...
        public override void ListVehicle()
        {
            ...
            {
                Console.WriteLine($"Placa - {carroLuxo.Placa}");
            }
            Console.WriteLine("Aperte qualquer botão");
            Console.ReadLine();
            Console.Clear();
